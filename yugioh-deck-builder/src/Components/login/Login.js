...
import { login } from '../../Firebase/Authenthication.js'
		...
		<section class="h-screen">
			<div class="px-6 py-12 h-full w-full">
				...
				<div class="flex flex-col justify-center align-middle items-center flex-wrap h-full g-4 text-gray-800">
					<div class="md:w-8/12 lg:w-6/12 mb-12 md:mb-0 w-full flex justify-center">
						<img
							src={image}
							class="w-[45rem] p-4"
							alt="Phone image"
					...
					<div class="md:w-8/12 lg:w-5/12 lg:ml-20">
						...
						<form onSubmit={handleSubmit}>
							...
							<div class="flex justify-between items-center mb-6 w-[44rem]">
								<div class="form-group form-check">
									<input
										type="checkbox"
										class="form-check-input appearance-none h-4 w-4 border border-gray-300 rounded-sm bg-white checked:bg-slate-800 checked:border-black focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer"
										id="exampleCheck3"
										checked
									/>
