...
import CardDisplay from '../homepage/CardDisplay'
...
function Decks(props) {
    ...
    return (
        <div className='h-screen w-full flex flex-row'>
            <div className='flex flex-col h-full w-full gap-6 bg-green-600 p-4'>
            ...
            <div className='flex flex-col bg-orange-600 w-full gap-3 p-4'>
