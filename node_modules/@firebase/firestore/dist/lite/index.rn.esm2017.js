...
=======
 */ const A = "ok", P = "cancelled", T = "unknown", R = "invalid-argument", I = "deadline-exceeded", V = "not-found", p = "already-exists", y = "permission-denied", w = "unauthenticated", g = "resource-exhausted", F = "failed-precondition", v = "aborted", D = "out-of-range", b = "unimplemented", C = "internal", S = "unavailable", N = "data-loss";
...
=======
      ...
      default:
        return t >= 200 && t < 300 ? A : t >= 400 && t < 500 ? F : t >= 500 && t < 600 ? C : T;
>>>>>>> origin/main-placeholder
    }
}
...
class __PRIVATE_RestConnection {
    constructor(t) {
        ...
        this.m = e + "://" + t.host, this.A = `projects/${r}/databases/${n}`, this.P = "(default)" === this.databaseId.database ? `project_id=${r}` : `project_id=${r}&database_id=${n}`;
    }
    get T() {
>>>>>>> origin/main-placeholder
...
class __PRIVATE_DatastoreImpl extends class Datastore {} {
    ...
    X() {
        if (this.Z) throw new FirestoreError(F, "The client has already been terminated.");
    }
...
=======
        ...
        if (__PRIVATE_isWrite(this.rt) && z.test(t)) throw this.lt('Document fields cannot begin and end with "__"');
>>>>>>> origin/main-placeholder
    }
}
 ...
 */ (t._query, t.firestore._databaseId, e, n[0]._document, r);
    {
        ...
        return function(t, e, n, r, s, i) {
            ...
            return new Wt(u, i);
=======
                for (const r of __PRIVATE_queryOrderBy(t)) if (r.field.isKeyField()) s.push(__PRIVATE_refValue(e, n.key)); else {
...
class __PRIVATE_TransactionRunner {
    constructor(t, e, r, n, i) {
        ...
        this.deferred = i, this.At = r.maxAttempts, this.Pt = new __PRIVATE_ExponentialBackoff(this.asyncQueue, "transaction_retry" /* TimerId.TransactionRetry */);
    }
    /** Runs the transaction and sets the result on deferred. */    run() {
        this.At -= 1, this.Tt();
    }
...
=======
    It(t) {
        this.At > 0 && this.Vt(t) ? (this.At -= 1, this.asyncQueue.enqueueAndForget((() => (this.Tt(), 
        Promise.resolve())))) : this.deferred.reject(t);
    }
    Vt(t) {
>>>>>>> origin/main-placeholder
...
=======
     */    async qt() {
        if (0 !== this.wt.length) {
            try {
                await this.wt[0](), this.wt.shift(), this.Pt.reset();
>>>>>>> origin/main-placeholder
            } catch (t) {
                if (!
                /**
 ...
 */ (n, e), n);
    ...
    // RUNTIME_ENV and BUILD_TARGET are replaced by real values during the compilation
    n("firestore-lite", "4.1.0", "rn"), n("firestore-lite", "4.1.0", "esm2017");
}();
