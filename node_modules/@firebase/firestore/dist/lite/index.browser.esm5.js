...
=======
var g = "10.1.0", w = new l("@firebase/firestore");
...
=======
 */ var P = "cancelled", F = "unknown", V = "invalid-argument", O = "deadline-exceeded", N = "not-found", D = "permission-denied", q = "unauthenticated", R = "resource-exhausted", x = "failed-precondition", C = "aborted", j = "out-of-range", L = "unimplemented", M = "internal", U = "unavailable", B = /** @class */ function(e) {
>>>>>>> origin/main-placeholder
    /** @hideconstructor */
    function n(
    /**
 ...
 */ function Ae(t) {
    var e = A(t);
    if (!e.B) if ("F" /* LimitType.First */ === e.limitType) e.B = be(e.path, e.collectionGroup, Ie(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        // Flip the orderBy directions since we want the last results
        ...
        // We need to swap the cursors to match the now-flipped query ordering.
                var u = e.endAt ? new Yt(e.endAt.position, e.endAt.inclusive) : null, s = e.startAt ? new Yt(e.startAt.position, e.startAt.inclusive) : null;
        // Now return as a LimitType.First query.
                e.B = be(e.path, e.collectionGroup, n, e.filters, e.limit, u, s);
    }
    return e.B;
}
...
=======
    ...
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).serializer = t, r.$ = n, r;
    }
    return t(n, e), n;
}(Ve), Re = function(t, e) {
    this.field = t, this.transform = e;
...
=======
        this.L = t, this.timerId = e, this.M = n, this.k = r, this.U = i, this.j = 0, this.W = null, 
>>>>>>> origin/main-placeholder
...
=======
        var n = Math.floor(this.j + this.J()), r = Math.max(0, Date.now() - this.K), i = Math.max(0, n - r);
        // Guard against lastAttemptTime being in the future due to a clock change.
        ...
        this.W = this.L.enqueueAfterDelay(this.timerId, i, (function() {
>>>>>>> origin/main-placeholder
...
=======
    ...
    function n(t, n, r, i) {
        var o = this;
        return (o = e.call(this) || this).authCredentials = t, o.appCheckCredentials = n, 
        o.connection = r, o.serializer = i, o.Z = !1, o;
    }
    return t(n, e), n.prototype.X = function() {
        if (this.Z) throw new B(x, "The client has already been terminated.");
    }, 
...
=======
                            var n = Ze(t, e.found.name), r = Ye(e.found.updateTime), i = e.found.createTime ? Ye(e.found.createTime) : fe.min(), o = new ge({
>>>>>>> origin/main-placeholder
                                mapValue: {
...
=======
                            ...
                            I(!!e.missing), I(!!e.readTime);
                            var n = Ze(t, e.missing), r = Ye(e.readTime);
 ...
 */ function Fn(t, e) {
    ...
    if (!(t instanceof An || t instanceof Pn)) throw new B(V, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var a = t._path.child(et.fromString.apply(et, r([ e ], n, !1)));
...
=======
    1 === arguments.length && (e = Tt.C()), ot("doc", "path", e), t instanceof wn) {
        var o = et.fromString.apply(et, r([ e ], n, !1));
...
=======
 */ function Nn(t, e) {
    return t = p(t), e = p(e), (t instanceof An || t instanceof Pn) && (e instanceof An || e instanceof Pn) && t.firestore === e.firestore && t.path === e.path && t.converter === e.converter
>>>>>>> origin/main-placeholder
    /**
...
=======
    /** Returns a new context with the specified settings overwritten. */ t.prototype.nt = function(e) {
        ...
        return cr(t, this.settings.methodName, this.settings.ct || !1, this.path, this.settings.ht);
>>>>>>> origin/main-placeholder
    }, 
...
=======
        ...
        if (Bn(this.rt) && Ln.test(t)) throw this.lt('Document fields cannot begin and end with "__"');
    }, t;
}(), Kn = /** @class */ function() {
    function t(t, e, n) {
...
/** Parse document data from a set() call. */ function Qn(t, e, n, r, i, o) {
    void 0 === o && (o = {});
    var a = t.dt(o.merge || o.mergeFields ? 2 /* UserDataSource.MergeSet */ : 0 /* UserDataSource.Set */ , e, n, i);
...
=======
        if (2 /* UserDataSource.MergeSet */ !== t.rt) throw 1 /* UserDataSource.Update */ === t.rt ? t.lt("".concat(this._methodName, "() can only appear at the top level of your update data")) : t.lt("".concat(this._methodName, "() cannot be used with set() unless you pass {merge:true}"));
>>>>>>> origin/main-placeholder
...
=======
    ...
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = Hn(this, t, 
        /*array=*/ !0), n = this.ft.map((function(t) {
            return nr(t, e);
        })), r = new Ne(n);
...
=======
    ...
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = new qe(t.serializer, Fe(t.serializer, this.Et));
...
/** Parse update data from an update() call. */ function $n(t, e, n, r) {
    var i = t.dt(1 /* UserDataSource.Update */ , e, n);
...
/** Parse update data from a list of field/value arguments. */ function tr(t, e, n, r, i, o) {
    var a = t.dt(1 /* UserDataSource.Update */ , e, n), u = [ ar(e, r, n) ], s = [ i ];
...
=======
 */ function er(t, e, n, r) {
    return void 0 === r && (r = !1), nr(n, t.dt(r ? 4 /* UserDataSource.ArrayArgument */ : 3 /* UserDataSource.Argument */ , e));
>>>>>>> origin/main-placeholder
}
...
=======
        if (!Bn(e.rt)) throw e.lt("".concat(t._methodName, "() can only be used with update() and set()"));
...
=======
function ir(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof Dt || t instanceof jn || t instanceof qn || t instanceof An || t instanceof Cn);
}
...
=======
function dr(t, e) {
    return t = p(t), e = p(e), t instanceof fr && e instanceof fr ? t._firestore === e._firestore && t._key.isEqual(e._key) && (null === t._document ? null === e._document : t._document.isEqual(e._document)) && t._converter === e._converter : t instanceof pr && e instanceof pr && Dn(t.query, e.query) && St(t.docs, e.docs, dr)
>>>>>>> origin/main-placeholder
    /**
 * Helper that calls `fromDotSeparatedString()` but wraps any error thrown.
 */;
            ...
            if (i.isKeyField()) {
                ...
                if ("in" /* Operator.IN */ === o || "not-in" /* Operator.NOT_IN */ === o) {
                    ...
                    for (var s = [], c = 0, l = a; c < l.length; c++) {
                        ...
                        s.push(Nr(r, t, f));
=======
        return jr(t._query, e), new In(t.firestore, t.converter, Pe(t._query, e));
    }, n.prototype._parse = function(t) {
...
=======
                    return e = A(t), i = nn(e.serializer, Ae(r)), [ 4 /*yield*/ , e.g("RunQuery", i.parent, {
>>>>>>> origin/main-placeholder
...
=======
                            var r = Ze(t, e.name), i = Ye(e.updateTime), o = e.createTime ? Ye(e.createTime) : fe.min(), a = new ge({
                                mapValue: {
                                    fields: e.fields
                                }
...
function Gr(t, e, n) {
    var r = Ur((t = ct(t, An)).converter, e, n), i = Qn(Gn(t.firestore), "setDoc", t._key, r, null !== t.converter, n);
    return dn(vn(t.firestore), [ i.toMutation(t._key, xe.none()) ]);
}

function Qr(t, e, n) {
    for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
    var o, a = Gn((t = ct(t, An)).firestore);
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
...
=======
 */ function Wr(t) {
    return dn(vn((t = ct(t, An)).firestore), [ new Me(t._key, xe.none()) ]);
>>>>>>> origin/main-placeholder
}
...
=======
 */ function Hr(t, e) {
    var n = On(t = ct(t, Pn)), r = Ur(t.converter, e), i = Qn(Gn(t.firestore), "addDoc", n._key, r, null !== n.converter, {});
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    }(o.serializer, Ae(r), i), u = a.request, s = a.tt, c = u.parent, o.connection.P || delete u.parent, 
...
=======
 */ function ei(t, e) {
    return Dn(t.query, e.query) && m(t.data(), e.data());
>>>>>>> origin/main-placeholder
}
 ...
 */ var ui = /** @class */ function() {
    ...
    return t.prototype.set = function(t, e, n) {
        this._verifyNotCommitted();
        var r = si(t, this._firestore), i = Ur(r.converter, e, n), o = Qn(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
...
=======
    ...
    function t(t, e, n, r, i) {
        this.asyncQueue = t, this.datastore = e, this.options = n, this.updateFunction = r, 
        this.deferred = i, this.At = n.maxAttempts, this.Tt = new hn(this.asyncQueue, "transaction_retry" /* TimerId.TransactionRetry */)
        /** Runs the transaction and sets the result on deferred. */;
    }
    return t.prototype.run = function() {
        this.At -= 1, this.Pt();
        ...
        this.Tt.H((function() {
            return e(t, void 0, void 0, (function() {
                var t, e, r = this;
                return n(this, (function(n) {
                    return t = new li(this.datastore), (e = this.Rt(t)) && e.then((function(e) {
>>>>>>> origin/main-placeholder
...
=======
        ...
        var e = this;
        this.At > 0 && this.Vt(t) ? (this.At -= 1, this.asyncQueue.enqueueAndForget((function() {
            return e.Pt(), Promise.resolve();
        }))) : this.deferred.reject(t);
    }, t.prototype.Vt = function(t) {
>>>>>>> origin/main-placeholder
...
=======
    ...
    function t() {
        ...
        this.Ct = [], 
        // Backoff timer used to schedule retries for retryable operations
        this.Tt = new hn(this, "async_queue_retry" /* TimerId.AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.St = function() {
            var e = pi();
            e && b("AsyncQueue", "Visibility state changed to " + e.visibilityState), t.Tt.Y();
        };
        var e = pi();
...
=======
                  ...
                  case 2:
                    return n.sent(), this.wt.shift(), this.Tt.reset(), [ 3 /*break*/ , 4 ];
>>>>>>> origin/main-placeholder
...
=======
        ...
        var r = si(t, this._firestore), i = Ur(r.converter, e, n), o = Qn(this._dataReader, "Transaction.set", r._key, i, null !== r.converter, n);
        return this._transaction.set(r._key, o), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
        var o, a = si(t, this._firestore);
...
=======
a("firestore-lite", "4.1.0", ""), a("firestore-lite", "4.1.0", "esm5");

export { Sn as AggregateField, kn as AggregateQuerySnapshot, qn as Bytes, Pn as CollectionReference, An as DocumentReference, fr as DocumentSnapshot, Rn as FieldPath, Cn as FieldValue, wn as Firestore, B as FirestoreError, jn as GeoPoint, In as Query, br as QueryCompositeFilterConstraint, vr as QueryConstraint, hr as QueryDocumentSnapshot, Nr as QueryEndAtConstraint, wr as QueryFieldFilterConstraint, Ir as QueryLimitConstraint, Sr as QueryOrderByConstraint, pr as QuerySnapshot, Fr as QueryStartAtConstraint, Dt as Timestamp, vi as Transaction, ui as WriteBatch, Hr as addDoc, ti as aggregateFieldEqual, ei as aggregateQuerySnapshotEqual, Er as and, oi as arrayRemove, ii as arrayUnion, Zr as average, Fn as collection, Vn as collectionGroup, Tn as connectFirestoreEmulator, $r as count, Wr as deleteDoc, ni as deleteField, On as doc, xn as documentId, qr as endAt, Dr as endBefore, Jr as getAggregate, Yr as getCount, zr as getDoc, Kr as getDocs, bn as getFirestore, ai as increment, _n as initializeFirestore, Ar as limit, Pr as limitToLast, Tr as or, kr as orderBy, gr as query, Dn as queryEqual, Nn as refEqual, gi as runTransaction, ri as serverTimestamp, Gr as setDoc, _ as setLogLevel, dr as snapshotEqual, Or as startAfter, Vr as startAt, Xr as sum, En as terminate, Qr as updateDoc, _r as where, ci as writeBatch };
>>>>>>> origin/main-placeholder
