  ...
  return (
    <div className='sticky flex flex-row justify-between align-middle flex-wrap bg-black w-full h-28 z-20 py-4 px-4'>
      ...
      <ul className='flex justify-center align-middle list-none text-center pt-6 gap-2'>
        <li><a href='#' className='m-8 text-white decoration-none text-base font-semibold uppercase hover:text-black hover:bg-white hover:rounded-2xl hover:px-6 hover:py-2 hover:transition-all ease-in-out duration-300'><Link to="/decks-list">Decks</Link></a></li>
        ...
        <li><a href="/#" className='m-4 text-white decoration-none text-base font-semibold uppercase hover:text-black hover:bg-white hover:rounded-2xl hover:px-6 hover:py-2 hover:transition-all ease-in-out duration-300'><Link to="/profile">Profile</Link></a></li>
      </ul>
