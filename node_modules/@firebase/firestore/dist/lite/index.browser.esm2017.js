...
=======
    It(t) {
        this.At > 0 && this.Vt(t) ? (this.At -= 1, this.asyncQueue.enqueueAndForget((() => (this.Pt(), 
        Promise.resolve())))) : this.deferred.reject(t);
    }
    Vt(t) {
>>>>>>> origin/main-placeholder
 ...
 */ (n, e), n);
    ...
    // RUNTIME_ENV and BUILD_TARGET are replaced by real values during the compilation
    registerVersion("firestore-lite", "4.1.0", ""), registerVersion("firestore-lite", "4.1.0", "esm2017");
}();
